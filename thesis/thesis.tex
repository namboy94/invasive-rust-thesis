...
Im Rahmen dieser Arbeit wurde das octorust Programm und die zugehörige octolib Bibliothek entwickelt,
welche es ermöglichen, Rust auf dem IRTSS Betriebssystem zu verwenden. Der Einsatz von Rust
ermöglicht das speichersichere Programmieren ohne einen Garbage Collector. Um dies zu erreichen,
werden keine oder nur wenige Kompromisse bei der Laufzeit eines Programmes in Kauf genommen. Daher
bietet Rust in gewissen Situationen einen Vorteil gegenüber den bereits von IRTSS unterstützten Sprachen.
