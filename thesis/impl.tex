...
\texttt{\textsc{\textbf{-{}-target}}}-Option den Pfad zur Spezifikations-JSON-Datei.
...
Alternativ kann man das \textit{libcore} Cargo-Projekt direkt durch die Abhängigkeiten in der
\texttt{\textsc{\textbf{Cargo.toml}}} Datei eines Cargo Projekts einbinden.
