...
angewandt werden.
Insbesondere kann ein Typ nicht das \textit{Copy}- als auch  das \textit{Drop}-Trait implementieren,
da Typen die das \textit{Drop}-Trait implementieren beim Verlassen des Geltungsbereichs einen Einfluss außerhalb ihres
...
\textit{Stacktrace} und beendet darauf die Ausführung des Programms.
...
Außerdem können unsichere Funktionen, beispielsweise solche die mithilfe der
